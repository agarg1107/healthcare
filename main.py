...
def Save():
    ...
    mob = mobile.get()
    mobile.set('')
    if N1 == "" or C1 == "Select Class" or D2 == "" or Re1 == "" or S1 == "" or temp == "" or res == "" or F1 == "" or M1 == "":
...
def reg_page():
    ...
    customtkinter.CTkLabel(obj, text="Class:", text_color=textcolor,font=(fontmain, 20)).place(x=480, y=55)
    ...
    global Class
    Class = Combobox(obj, values=["15", "14", "13", "12", "11", "10"], font="Roboto 10", width=17, state="r")
