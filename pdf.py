...
def add_item():
    ...
    clear_item()
    invoice_item.append("1")
    invoice_item.append("151020")
    invoice_item.append("15ays")
    invoice_item.append("154")
    invoice_item.append("12")
    invoice_item.append("12")
...
def generate_invoice():
    ...
    doc.render({"patientname": name,
                "docname": "Aman",
                "date": "15/10/2003",
                "sno" : "1",
                "invoice_list": invoice_list,
                "grandtotal": subtotal,
                "totalgst": str(salestax * 100) + "%"})
